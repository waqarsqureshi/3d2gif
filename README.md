...
If your system only provides `opencv` (not `opencv4`) in pkg-config, replace `opencv4` accordingly. The makefiles in `/home/runner/work/3d2gif/3d2gif/OBJ/makefile_obj2gif` and `/home/runner/work/3d2gif/3d2gif/PLY/makefile_ply2gif` auto-detect either package.
## How to run the code
