...
If your system only provides `opencv` (not `opencv4`) in pkg-config, replace `opencv4` accordingly. The makefiles in `OBJ/makefile_obj2gif` and `PLY/makefile_ply2gif` auto-detect either package.
## How to run the code
